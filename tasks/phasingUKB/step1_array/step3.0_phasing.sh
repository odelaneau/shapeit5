...
for CHR in 20; do
	...
	dx run app-swiss-army-knife --folder "/Phasing/PhasingSNParray/step2_phasing/" -iimage_file="/docker/shapeit5_0.0.1.tar.gz" -icmd="SHAPEIT5_phase1_static --input $VCF --map $MAP --output $BCF --region $CHR --log $LOG --thread 32 && bcftools index $BCF --threads 32" --tag phasingSA --tag chr20 --instance-type mem2_ssd1_v2_x32 --priority normal --name shapeit5_phase -y
