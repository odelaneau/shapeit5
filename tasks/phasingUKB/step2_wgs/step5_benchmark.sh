...
while read LINE; do
	...
	OUT=$(basename $SHP .bcf)\.fqr
	LOG=$(basename $SHP .bcf)\.fqr.log
	dx run app-swiss-army-knife -iimage_file="/docker/shapeit5_0.0.1.tar.gz" --folder="/Phasing/PhasingWGS/step6_runshapeit/" -icmd="SHAPEIT5_switch_static --validation $VAL --estimation $SHP --frequency $FQR --pedigree $PED --region $oREG --output $OUT --log $LOG --thread 2" --tag benchWGS --tag switchSHP3_$iREG --tag chr20 --instance-type mem3_ssd1_v2_x2 --priority low --name benchWGS_switchSHP3_$iREG -y

	SHP=/mnt/project/Phasing/PhasingWGS/step6_runshapeit/benchmark_ukb23352_c20_qc_v1.$iREG\.shapeit5.dc2.dr4.bcf
	OUT=$(basename $SHP .bcf)\.fqr
	LOG=$(basename $SHP .bcf)\.fqr.log
	dx run app-swiss-army-knife -iimage_file="/docker/shapeit5_0.0.1.tar.gz" --folder="/Phasing/PhasingWGS/step6_runshapeit/" -icmd="SHAPEIT5_switch_static --validation $VAL --estimation $SHP --frequency $FQR --pedigree $PED --region $oREG --output $OUT --log $LOG --thread 2" --tag benchWGS --tag switchSHP3_$iREG --tag chr20 --instance-type mem3_ssd1_v2_x2 --priority low --name benchWGS_switchSHP3_$iREG -y

	SHP=/mnt/project/Phasing/PhasingWGS/step6_runshapeit/benchmark_ukb23352_c20_qc_v1.$iREG\.shapeit5.dc4.dr4.bcf
	OUT=$(basename $SHP .bcf)\.fqr
	LOG=$(basename $SHP .bcf)\.fqr.log
	dx run app-swiss-army-knife -iimage_file="/docker/shapeit5_0.0.1.tar.gz" --folder="/Phasing/PhasingWGS/step6_runshapeit/" -icmd="SHAPEIT5_switch_static --validation $VAL --estimation $SHP --frequency $FQR --pedigree $PED --region $oREG --output $OUT --log $LOG --thread 2" --tag benchWGS --tag switchSHP3_$iREG --tag chr20 --instance-type mem3_ssd1_v2_x2 --priority low --name benchWGS_switchSHP3_$iREG -y

	SHP=/mnt/project/Phasing/PhasingWGS/step6_runshapeit/benchmark_ukb23352_c20_qc_v1.$iREG\.shapeit5.dc2.dr8.bcf
	OUT=$(basename $SHP .bcf)\.fqr
	LOG=$(basename $SHP .bcf)\.fqr.log
	dx run app-swiss-army-knife -iimage_file="/docker/shapeit5_0.0.1.tar.gz" --folder="/Phasing/PhasingWGS/step6_runshapeit/" -icmd="SHAPEIT5_switch_static --validation $VAL --estimation $SHP --frequency $FQR --pedigree $PED --region $oREG --output $OUT --log $LOG --thread 2" --tag benchWGS --tag switchSHP3_$iREG --tag chr20 --instance-type mem3_ssd1_v2_x2 --priority low --name benchWGS_switchSHP3_$iREG -y

	SHP=/mnt/project/Phasing/PhasingWGS/step6_runshapeit/benchmark_ukb23352_c20_qc_v1.$iREG\.shapeit5.dc4.dr8.bcf
	OUT=$(basename $SHP .bcf)\.fqr
	LOG=$(basename $SHP .bcf)\.fqr.log
	dx run app-swiss-army-knife -iimage_file="/docker/shapeit5_0.0.1.tar.gz" --folder="/Phasing/PhasingWGS/step6_runshapeit/" -icmd="SHAPEIT5_switch_static --validation $VAL --estimation $SHP --frequency $FQR --pedigree $PED --region $oREG --output $OUT --log $LOG --thread 2" --tag benchWGS --tag switchSHP3_$iREG --tag chr20 --instance-type mem3_ssd1_v2_x2 --priority low --name benchWGS_switchSHP3_$iREG -y

	SHP=/mnt/project/Phasing/PhasingWGS/step6_runshapeit/benchmark_ukb23352_c20_qc_v1.$iREG\.shapeit5.dc8.dr8.bcf
	OUT=$(basename $SHP .bcf)\.fqr
	LOG=$(basename $SHP .bcf)\.fqr.log
	dx run app-swiss-army-knife -iimage_file="/docker/shapeit5_0.0.1.tar.gz" --folder="/Phasing/PhasingWGS/step6_runshapeit/" -icmd="SHAPEIT5_switch_static --validation $VAL --estimation $SHP --frequency $FQR --pedigree $PED --region $oREG --output $OUT --log $LOG --thread 2" --tag benchWGS --tag switchSHP3_$iREG --tag chr20 --instance-type mem3_ssd1_v2_x2 --priority low --name benchWGS_switchSHP3_$iREG -y
