...
for N in 2000 5000 10000 20000 50000 100000 147754; do
	while read LINE; do
		...
		#dx run app-swiss-army-knife -iimage_file="/docker/shapeit5_0.0.1.tar.gz" --folder="/Phasing/PhasingWGS/step3_runbeagle/" -icmd="SHAPEIT5_switch_static --validation $VAL --estimation $VCF --frequency $FRQ --pedigree $PED --region $oREG --output $OUT --log $LOG --thread 2" --tag benchWGS --tag switchBGL1 --tag $iREG --instance-type mem3_ssd1_v2_x2 --priority low --name benchWGS_switchBGL1_$iREG -y
		...
		#dx run app-swiss-army-knife -iimage_file="/docker/shapeit5_0.0.1.tar.gz" --folder="/Phasing/PhasingWGS/step3_runbeagle/" -icmd="SHAPEIT5_switch_static --validation $VAL --estimation $VCF --frequency $FRQ --pedigree $PED --region $oREG --output $OUT --log $LOG --thread 2" --tag benchWGS --tag switchBGL2 --tag $iREG --instance-type mem3_ssd1_v2_x2 --priority low --name benchWGS_switchBGL2_$iREG -y
		...
		#dx run app-swiss-army-knife -iimage_file="/docker/shapeit5_0.0.1.tar.gz" --folder="/Phasing/PhasingWGS/step3_runbeagle/" -icmd="SHAPEIT5_switch_static --validation $VAL --estimation $VCF --frequency $FRQ --pedigree $PED --region $oREG --output $OUT --log $LOG --thread 2" --tag benchWGS --tag switchBGL3 --tag $iREG --instance-type mem3_ssd1_v2_x2 --priority low --name benchWGS_switchBGL3_$iREG -y
		...
		#dx run app-swiss-army-knife -iimage_file="/docker/shapeit5_0.0.1.tar.gz" --folder="/Phasing/PhasingWGS/step3_runbeagle/" -icmd="SHAPEIT5_switch_static --validation $VAL --estimation $VCF --frequency $FRQ --pedigree $PED --region $oREG --output $OUT --log $LOG --thread 2" --tag benchWGS --tag switchBGL4 --tag $iREG --instance-type mem3_ssd1_v2_x2 --priority low --name benchWGS_switchBGL4_$iREG -y
