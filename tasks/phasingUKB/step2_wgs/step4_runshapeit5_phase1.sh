...
#	dx run app-swiss-army-knife -iimage_file="/docker/shapeit5_0.0.1.tar.gz" --folder="/Phasing/PhasingWGS/step4_runshapeit/" -icmd="/usr/bin/time -vo $TIM SHAPEIT5_phase1_static --input $BCF --scaffold $SCA --map $MAP --output $OUT --thread 32 --log $LOG --filter-maf 0.001 --filter-snp --region $REG && bcftools index -f $OUT --threads 8" --tag benchWGS --tag shapeit5 --tag chr20 --instance-type mem3_ssd1_v2_x32 --priority low --name benchWGS_shapeit5_$REG -y
	...
	OUT=benchmark_ukb23352_c20_qc_v1.$REG\.shapeit5.default.modulo25.bcf
	LOG=benchmark_ukb23352_c20_qc_v1.$REG\.shapeit5.default.modulo25.log
	TIM=benchmark_ukb23352_c20_qc_v1.$REG\.shapeit5.default.modulo25.time

	dx run app-swiss-army-knife -iimage_file="/docker/shapeit5_0.0.1.tar.gz" --folder="/Phasing/PhasingWGS/step4_runshapeit/" -icmd="/usr/bin/time -vo $TIM SHAPEIT5_phase1_static --input $BCF --map $MAP --output $OUT --thread 32 --log $LOG --filter-maf 0.001 --filter-snp --pbwt-modulo 0.025 --region $REG && bcftools index -f $OUT --threads 8" --tag benchWGS --tag shapeit5 --tag chr20 --instance-type mem3_ssd1_v2_x32 --priority low --name benchWGS_shapeit5_$REG -y

	OUT=benchmark_ukb23352_c20_qc_v1.$REG\.shapeit5.scaffold.modulo25.bcf
	LOG=benchmark_ukb23352_c20_qc_v1.$REG\.shapeit5.scaffold.modulo25.log
	TIM=benchmark_ukb23352_c20_qc_v1.$REG\.shapeit5.scaffold.modulo25.time
