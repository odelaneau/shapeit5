...
for N in 2000 5000 10000 20000 50000 100000 147754; do
	...
	while read LINE; do
		REG=$(echo $LINE | awk '{ print $3; }')
		echo /mnt/project/Phasing/PhasingWGS/step4_runshapeit_phase1/N$N\/benchmark_ukb23352_c20_qc_v1.subset.N$N\.$REG\.shapeit5.default.bcf >> benchmark_ukb23352_c20_qc_v1.subset.N$N\.shapeit5.default.list
	done < /home/olivier/Dropbox/Repository/shapeit5/tasks/phasingUKB/step2_wgs/step2_splitchunks/chr20.size4Mb.txt
	...
	dx run app-swiss-army-knife -iimage_file="/docker/$DOCKER" --folder="/Phasing/PhasingWGS/step4_runshapeit_phase1/N$N/" -icmd="SHAPEIT5_ligate_static --input $TXT --output $OUT --thread 2 --index" --tag benchWGS --tag ligate --tag chr20 --instance-type mem2_ssd1_v2_x2 --priority normal --name benchWGS_ligate -y
