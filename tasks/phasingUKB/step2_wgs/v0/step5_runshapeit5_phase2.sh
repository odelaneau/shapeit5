...
while read LINE; do
	...
	OUT=benchmark_ukb23352_c20_qc_v1.subset.N$N\.$SREG\.shapeit5.ped2.bcf
	TIM=benchmark_ukb23352_c20_qc_v1.subset.N$N\.$SREG\.shapeit5.ped2.time
	LOG=benchmark_ukb23352_c20_qc_v1.subset.N$N\.$SREG\.shapeit5.ped2.log
