...
for N in 2000 5000 10000 20000 50000 100000 147754; do
	...
	#RUN ligate
	TXT=/mnt/project/Phasing/PhasingWGS/step4_runshapeit_phase1/N$N\.test/benchmark_ukb23352_c20_qc_v1.subset.N$N\.shapeit5.default.list
	...
	dx run app-swiss-army-knife -iimage_file="/docker/$DOCKER" --folder="/Phasing/PhasingWGS/step4_runshapeit_phase1/N$N.test/" -icmd="/usr/bin/time -vo $TIM SHAPEIT5_ligate_static --input $TXT --output $OUT --thread 2 --index" --tag benchWGS --tag ligate --tag chr20 --instance-type mem2_ssd1_v2_x2 --priority normal --name benchWGS_ligate -y
done
